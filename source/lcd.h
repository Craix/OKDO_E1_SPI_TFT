...
#define LCD_RST_0 GPIO_PinWrite(SPI_TFT_LCD_RESET_GPIO, SPI_TFT_LCD_RESET_PORT, SPI_TFT_LCD_RESET_PIN, 0)
#define LCD_RST_1 GPIO_PinWrite(SPI_TFT_LCD_RESET_GPIO, SPI_TFT_LCD_RESET_PORT, SPI_TFT_LCD_RESET_PIN, 1)

#define LCD_DC_0 GPIO_PinWrite(SPI_TFT_LCD_DC_GPIO, SPI_TFT_LCD_DC_PORT, SPI_TFT_LCD_DC_PIN, 0)
#define LCD_DC_1 GPIO_PinWrite(SPI_TFT_LCD_DC_GPIO, SPI_TFT_LCD_DC_PORT, SPI_TFT_LCD_DC_PIN, 1)
