...
pin_labels:
- {pin_num: '60', pin_signal: PIO0_26/FC2_RXD_SDA_MOSI_DATA/CLKOUT/CT_INP14/SCT0_OUT5/USB0_IDVALUE/FC0_SCK/HS_SPI_MOSI/SECURE_GPIO0_26, label: LCD, identifier: SDA}
...
- {pin_num: '61', pin_signal: PIO1_2/CTIMER0_MAT3/SCT_GPI6/HS_SPI_SCK/USB1_PORTPWRN/PLU_OUT5, label: LCD, identifier: SCk;SCK}
- {pin_num: '68', pin_signal: PIO1_26/FC2_CTS_SDA_SSEL0/SCT0_OUT3/CT_INP3/UTICK_CAP1/HS_SPI_SSEL3/PLU_IN5, label: LCD, identifier: DC}
- {pin_num: '85', pin_signal: PIO1_27/FC2_RTS_SCL_SSEL1/SD0_D4/CTIMER0_MAT3/CLKOUT/PLU_IN4, label: LCD, identifier: RESET}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : SPI_TFT_LCD
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M33 (Core #0) */
void SPI_TFT_LCD(void)
{
    /* Enables the clock for the I/O controller.: Enable Clock. */
    CLOCK_EnableClock(kCLOCK_Iocon);
    ...
    GPIO_PinInit(SPI_TFT_LCD_DC_GPIO, SPI_TFT_LCD_DC_PORT, SPI_TFT_LCD_DC_PIN, &DC_config);
    ...
    GPIO_PinInit(SPI_TFT_LCD_RESET_GPIO, SPI_TFT_LCD_RESET_PORT, SPI_TFT_LCD_RESET_PIN, &RESET_config);
