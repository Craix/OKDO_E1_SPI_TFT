...
/*! @name PIO1_1 (number 59), LCD
  @{ */
#define SPI_TFT_LCD_SSEL_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define SPI_TFT_LCD_SSEL_PIN 1U                   /*!<@brief PORT pin number */
#define SPI_TFT_LCD_SSEL_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                                  /* @} */

/*! @name PIO1_2 (number 61), LCD
  @{ */
#define SPI_TFT_LCD_SCK_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define SPI_TFT_LCD_SCK_PIN 2U                   /*!<@brief PORT pin number */
#define SPI_TFT_LCD_SCK_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                 /* @} */

/*! @name PIO0_26 (number 60), LCD
  @{ */
#define SPI_TFT_LCD_SDA_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define SPI_TFT_LCD_SDA_PIN 26U                   /*!<@brief PORT pin number */
#define SPI_TFT_LCD_SDA_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define SPI_TFT_LCD_RESET_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define SPI_TFT_LCD_RESET_GPIO_PIN_MASK (1U << 27U) /*!<@brief GPIO pin mask */
#define SPI_TFT_LCD_RESET_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define SPI_TFT_LCD_RESET_PIN 27U                   /*!<@brief PORT pin number */
#define SPI_TFT_LCD_RESET_PIN_MASK (1U << 27U)      /*!<@brief PORT pin mask */
                                                    /* @} */
...
/* Symbols to be used with GPIO driver */
#define SPI_TFT_LCD_DC_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define SPI_TFT_LCD_DC_GPIO_PIN_MASK (1U << 26U) /*!<@brief GPIO pin mask */
#define SPI_TFT_LCD_DC_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define SPI_TFT_LCD_DC_PIN 26U                   /*!<@brief PORT pin number */
#define SPI_TFT_LCD_DC_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                                 /* @} */
 ...
 *
 */
void SPI_TFT_LCD(void); /* Function assigned for the Cortex-M33 (Core #0) */
